...
### [#](https://react.iamkasong.com/preparation/file.html#scheduler文件夹)[scheduler (opens new window)](https://github.com/facebook/react/tree/master/packages/scheduler)文件夹

Scheduler（调度器）的实现。

### [#](https://react.iamkasong.com/preparation/file.html#shared文件夹)[shared (opens new window)](https://github.com/facebook/react/tree/master/packages/shared)文件夹
...
### [#](https://react.iamkasong.com/preparation/file.html#renderer相关的文件夹)Renderer相关的文件夹
...
### [#](https://react.iamkasong.com/preparation/file.html#试验性包的文件夹)试验性包的文件夹
...
### [#](https://react.iamkasong.com/preparation/file.html#辅助包的文件夹)辅助包的文件夹
