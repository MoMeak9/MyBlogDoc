...
function objectFactory(...args) {
  ...
  // 判断返回对象，如果是引用类型，就返回这个引用类型的对象，否则返回新建的对象
